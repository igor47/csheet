  ...
  return (
    <ModalContent title="Add Item to Inventory">
      ...
      >
        ...
        <div
          id="armor-fields"
          class={clsx({ "d-none": selectedCategory !== "armor" })}
        >
        ...
        <div
          id="shield-fields"
          class={clsx({ "d-none": selectedCategory !== "shield" })}
        >
        ...
        <div
          id="weapon-fields"
          class={clsx({ "d-none": selectedCategory !== "weapon" })}
        >
          ...
          {/* Damage Rows */}
          <div class="mb-3">
            <label class="form-label" for="damage_row_count">Damage</label>
            <input type="hidden" name="damage_row_count" id="damage_row_count" value={damageRowCount} />
              ...
              return (
                <div class="row mb-2">
                  <div class="col-3">
                    ...
                    />
                    {numDiceError && <div class="invalid-feedback d-block small">{numDiceError}</div>}
                  </div>
