...
export const HitPointsEditForm = ({ characterId, currentHP, maxHitPoints, values, errors }: HitPointsEditFormProps) => {
        ...
        {showPreview && (
          <div class="mb-3">
            ...
            <small class="form-text text-muted">
              {action === 'restore' ? 'Restoring' : 'Losing'} {amount} HP: {currentHP} → {previewHP}
            </small>
          </div>
        )}
