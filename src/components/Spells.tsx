        ...
        <div class="col-12">
          ...
          >
            ...
            <div class="col-12 col-md-4 col-lg-2">
              <label for="level-filter" class="form-label">Max Level</label>
              <select
                id="level-filter"
                name="maxLevel"
                class="form-select"
              ...
              >
                ...
                <option value="0" selected={selectedMaxLevel === '0'}>Cantrips</option>
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map(level => (
                  <option value={level.toString()} selected={selectedMaxLevel === level.toString()}>
