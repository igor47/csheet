              ...
              {allSlots.length > 0 ? (
                <div class="table-responsive">
                  <table class="table table-sm table-hover small">
                    ...
                    <tbody>
                      {allSlots.map((row) => {
                        const spell = row.spell_id
                          ? spells.find((s) => s.id === row.spell_id)
                          : null
                                ...
                                <>
                                  ...
                                  {row.alwaysPrepared && (
                                    <span
                                      ...
                                      title="Always prepared (e.g., domain spell)"
                                    >
                ...
                <table class="table table-sm table-hover small">
                  ...
                  <tbody>
                    {sortedSpells.map((spell) => {
                      ...
                      const isInCantripSlot = wizardInfo.cantripSlots.some(
                        (slot) => slot.spell_id === spell.id
                      )
                      const isInPreparedSlot = wizardInfo.preparedSpells.some(
                        (slot) => slot.spell_id === spell.id
                      )
