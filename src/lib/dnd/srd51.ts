...
const SpeciesData: Species[] = [
  {
    ...
    lineages: [
      { name: "hill dwarf", abilityScoreModifiers: { wisdom: 1 } },
      { name: "mountain dwarf", abilityScoreModifiers: { strength: 2 } },
    ],
  },
  {
    name: "elf",
    ...
    lineages: [
      { name: "high elf", abilityScoreModifiers: { intelligence: 1 } },
      { name: "wood elf", abilityScoreModifiers: { wisdom: 1 } },
      { name: "drow", abilityScoreModifiers: { charisma: 1 } },
    ],
  },
  {
    name: "halfling",
    ...
    abilityScoreModifiers: { dexterity: 2 },
    lineages: [
      { name: "lightfoot", abilityScoreModifiers: { charisma: 1 } },
      { name: "stout", abilityScoreModifiers: { constitution: 1 } },
    ],
  },
  {
    name: "human",
  ...
  },
  {
    ...
    lineages: [
      { name: "forest gnome", abilityScoreModifiers: { dexterity: 1 } },
      { name: "rock gnome", abilityScoreModifiers: { constitution: 1 } },
      { name: "deep gnome", abilityScoreModifiers: { dexterity: 1 } },
    ],
  },
  {
    name: "half-elf",
...
const SpellProgressionTables: Partial<Record<ClassNameType, SpellProgressionTableRow[]>> = {
  ...
  cleric: [
    { level: 0, cantrips: 0, prepared: 0, slots: [0, 0, 0, 0, 0, 0, 0, 0, 0] },
    {
      level: 1,
      cantrips: 3,
      prepared_fn: (level, mod) => mod + level,
  ...
  paladin: [
    { level: 0, cantrips: 0, prepared: 0, slots: [0, 0, 0, 0, 0, 0, 0, 0, 0] },
    {
      level: 1,
      cantrips: 0,
      prepared_fn: (level, mod) => mod + Math.floor(level / 2),
      slots: [2, 0, 0, 0, 0],
    },
    {
      level: 2,
